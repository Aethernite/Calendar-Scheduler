...
import static com.company.utils.frontend.AnsiColorCodes.ANSI_RED;
import static com.company.utils.frontend.AnsiColorCodes.ANSI_RESET;

public class EditEventMenuView implements Command {
    private Command parent;
    private Event event;
    private int index;
    private Scanner sc = new Scanner(System.in);

    public EditEventMenuView(Command parent, Event event, int index){
        this.parent = parent;
        this.event = event;
        this.index = index;
    }
